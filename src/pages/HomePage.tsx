      ...
      <section id="contact" className="py-32 bg-brand-950 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-brand-600 text-xs font-body mt-3">
            ...
            <a href="mailto:connect@brandscape.media" className="text-brand-400 hover:text-white underline underline-offset-2 transition-colors">
              connect@brandscape.media
            </a>
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <a href="https://x.com/Skystunt" target="_blank" rel="noreferrer" className="text-brand-700 hover:text-brand-400 transition-colors" aria-label="X">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
              </a>
              <a href="https://www.instagram.com/raul_loves_turtles/" target="_blank" rel="noreferrer" className="text-brand-700 hover:text-brand-400 transition-colors" aria-label="Instagram">
